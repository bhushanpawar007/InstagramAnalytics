...
<html lang="en">
    ...
    <body onload="load()">
        ...
        $url = 'https://api.instagram.com/v1/users/self/?access_token=' . $_POST['access_token'];
        $media = 'https://api.instagram.com/v1/users/self/media/recent/?access_token=' . $_POST['access_token'];
...
for ($i = 0; $i < $countofRecentMedia; $i++) {
    ...
    echo '<th>';
    echo '<a href="tagSuggester.php?media_id='.$MyMediaData->data[$i]->id .'"> Suggest Hashtags to improve Likes</a>';
    echo '</th>';
...
?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-clock-o fa-fw"></i> How To Use This Site to Improve your Media Coverage
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title"> Login into Your Account   </h4>
                                  
                                </div>
                                <div class="timeline-body">
                                    <p>Login into Your Account or Else Create a new Account </p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Search </h4>
                                </div>
                                <div class="timeline-body">
                                    <p>Search for Hashtags by name or location and get theire details about post and hashtags they used.</p>
                                                          </div>
                            </div>
                        </li>
                        <li>
        ...
        <div class="col-lg-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-bell fa-fw"></i>Extras</div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="list-group">
                        <a href="PopularHashTags.php" class="list-group-item">
                            <i class="fa fa-comment fa-fw"></i> Most Popular HashTags on Instagram</a>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a class="btn btn-default btn-block" data-toggle="collapse" data-target="#demo">Download Details in Excel Sheet</a>
                    <div class="collapse" id="demo">
                        <a href="SendUserFollowerExcel.php" class="btn btn-primary" role="button" style="margin-top: 4%;width: 100%;">Get Follwers Data in Excel Sheet</a>
                        <a href="SendUserFollowsExcel.php   " class="btn btn-primary" role="button" style="margin-top: 7%;width: 100%;">Get Following Data in Excel Sheet</a>
                    </div>
                </div>
                <!-- /.panel-body -->
            </div>
